...
class StringCalculatorSpec extends ObjectBehavior
{
  ...
  function no_negative_numbers()
  {
    $this->shouldThrow(new InvalidArgumentException)->duringAdd('3, -2');
  }
  function ignore_numbers_one_thousand_or_greater()
  {
    $this->add('2, 2, 1000')->shouldEqual(4);
  }
  function it_allows_new_line_delimiters()
  {
    $this->add('2, 2\n2')->shouldEqual(6);
  }
}
